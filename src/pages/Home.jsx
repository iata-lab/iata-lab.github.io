...
<div className="user-text">
  ...
  <p>
    En 2022 aposté por presentarme a una plaza fija en el Instituto Nacional
    de Estadística (INE), dedicando dos años y medio a preparar oposiciones
    de forma constante. Superé el proceso en dos ocasiones, aunque sin
    alcanzar la nota de corte. Este proceso supuso un punto de inflexión
    personal: ante la falta de bolsa de empleo o interinidad en el Ministerio
    de Economía, no tenía posibilidades financieras para seguir estudiando y
    busqué en mí lo que siempre se me ha dado mejor: crecer haciendo, más que
    desde lo académico, y apoyarme en la interacción humana.
  </p>
  <p>
    Así, compaginé mis estudios con experiencia laboral en Europa,
    principalmente en una empresa de distribución de productos químicos y
    otros trabajos temporales, como en una fábrica en Noruega, mientras
    consolido mis conocimientos en inteligencia artificial y lenguajes de
    programación.
  </p>
</div>
      </article>
